...
#ifndef __jetauto_calibrate__CALIBRATEANGULARCONFIG_H__
#define __jetauto_calibrate__CALIBRATEANGULARCONFIG_H__
...
namespace jetauto_calibrate
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(CalibrateAngularConfig &config, const CalibrateAngularConfig &max, const CalibrateAngularConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const CalibrateAngularConfig &config1, const CalibrateAngularConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, CalibrateAngularConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const CalibrateAngularConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, CalibrateAngularConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const CalibrateAngularConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const CalibrateAngularConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, CalibrateAngularConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
  ...
  public:
    ...
    void setParams(CalibrateAngularConfig &config, const std::vector<AbstractParamDescriptionConstPtr> params)
    {
      for (std::vector<AbstractParamDescriptionConstPtr>::const_iterator _i = params.begin(); _i != params.end(); ++_i)
      {
        ...
        if("motor_turn_scale_correction"==(*_i)->name){motor_turn_scale_correction = boost::any_cast<double>(val);}
        if("odom_angular_scale_correction"==(*_i)->name){odom_angular_scale_correction = boost::any_cast<double>(val);}
        if("start_test_turn"==(*_i)->name){start_test_turn = boost::any_cast<bool>(val);}
        if("start_test_angular"==(*_i)->name){start_test_angular = boost::any_cast<bool>(val);}
      }
    }
...
double speed;
double tolerance;
double motor_turn_scale_correction;
double odom_angular_scale_correction;
bool start_test_turn;
bool start_test_angular;
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.motor_turn_scale_correction = 0.0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.motor_turn_scale_correction = 3.0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.motor_turn_scale_correction = 1.0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CalibrateAngularConfig::AbstractParamDescriptionConstPtr(new CalibrateAngularConfig::ParamDescription<double>("motor_turn_scale_correction", "double", 0, "Turn correction factor", "", &CalibrateAngularConfig::motor_turn_scale_correction)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(CalibrateAngularConfig::AbstractParamDescriptionConstPtr(new CalibrateAngularConfig::ParamDescription<double>("motor_turn_scale_correction", "double", 0, "Turn correction factor", "", &CalibrateAngularConfig::motor_turn_scale_correction)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.start_test_turn = 0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.start_test_turn = 1;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.start_test_turn = 0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CalibrateAngularConfig::AbstractParamDescriptionConstPtr(new CalibrateAngularConfig::ParamDescription<bool>("start_test_turn", "bool", 0, "Check to start the test", "", &CalibrateAngularConfig::start_test_turn)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(CalibrateAngularConfig::AbstractParamDescriptionConstPtr(new CalibrateAngularConfig::ParamDescription<bool>("start_test_turn", "bool", 0, "Check to start the test", "", &CalibrateAngularConfig::start_test_turn)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.start_test_angular = 0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.start_test_angular = 1;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.start_test_angular = 0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CalibrateAngularConfig::AbstractParamDescriptionConstPtr(new CalibrateAngularConfig::ParamDescription<bool>("start_test_angular", "bool", 0, "Check to start the test", "", &CalibrateAngularConfig::start_test_angular)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(CalibrateAngularConfig::AbstractParamDescriptionConstPtr(new CalibrateAngularConfig::ParamDescription<bool>("start_test_angular", "bool", 0, "Check to start the test", "", &CalibrateAngularConfig::start_test_angular)));
