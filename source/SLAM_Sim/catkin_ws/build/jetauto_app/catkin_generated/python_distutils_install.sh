...
echo_and_run cd "/home/build-error-ubuntu/carletonSLAM_V2/source/SLAM_Sim/catkin_ws/src/jetauto_app"
...
echo_and_run /usr/bin/env \
    ...
    "/home/build-error-ubuntu/carletonSLAM_V2/source/SLAM_Sim/catkin_ws/src/jetauto_app/setup.py" \
     \
    build --build-base "/home/build-error-ubuntu/carletonSLAM_V2/source/SLAM_Sim/catkin_ws/build/jetauto_app" \
    install \
    --root="${DESTDIR-/}" \
